                ...
                <table class="table ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $Shop->address }}</td>
                            <td>{{ ShopBalance($Shop->id) }}</td>
                            <td>
                                <form action="{{ action('BillingController\ShopController@destroy',$Shop->id) }}" method="POST">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="_method" value="DELETE">
                                    <a href="{{ action('BillingController\ShopController@show',$Shop->id) }}" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true" style="color:#fff"></i></a>
